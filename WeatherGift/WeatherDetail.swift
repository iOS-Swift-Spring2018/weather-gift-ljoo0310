...
class WeatherDetail: WeatherLocation { // subclass WeatherDetail inherits from superclass WeatherLocation
    ...
    func getWeather(completed: @escaping () -> ()) {
        ...
        Alamofire.request(weatherURL).responseJSON { response in // waits for response until function is done running
            ...
            case .success(let value):
                ...
                self.dailyForecastArray = [] // need empty out array or data will pile up
